...
public class KeyManagerBuilder {
  ...
  static class SunPasswordStageImpl implements SunPasswordStage {
    ...
    SunPasswordStageImpl(
        SupplierWithThrowable<KeyManagerFactory, GeneralSecurityException> keyManagerFactory,
  ...
  static class NewSunParametersStageImpl implements NewSunParametersStage {
    ...
    public BuilderFinal withKeyStore(KeyStore keyStore, char[] keyStorePassword) {
      return withBuilders(
          () -> KeyStoreBuildersBuilder.builder().withKeyStore(keyStore, keyStorePassword).build());
    }
          ...
          () -> {
            KeyManagerFactory kmf =
                (provider == null)
                    ...
                    : KeyManagerFactory.getInstance(newSunX509, provider);
