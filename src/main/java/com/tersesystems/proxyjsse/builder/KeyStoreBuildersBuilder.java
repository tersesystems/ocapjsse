...
public class KeyStoreBuildersBuilder {
    ...
    public interface BuilderFinal {
        ...
        BuilderFinal withProtectionParameter(String type, Provider provider, KeyStore.ProtectionParameter protectionParameter);

        BuilderFinal withProtectionParameter(String type, Provider provider, File file, KeyStore.ProtectionParameter protection);
    ...
    static class BuilderFinalImpl implements BuilderFinal {
        ...
        public BuilderFinal withKeyStore(KeyStore keyStore, char[] keyStorePassword) {
            KeyStore.Builder builder = KeyStore.Builder.newInstance(keyStore, new KeyStore.PasswordProtection(keyStorePassword));
            this.builders.add(builder);
            return this;
        }

        @Override
        public BuilderFinal withProtectionParameter(String type, Provider provider, KeyStore.ProtectionParameter protectionParameter) {
        ...
        @Override
        public BuilderFinal withProtectionParameter(String type, Provider provider, File file, KeyStore.ProtectionParameter protection) {
