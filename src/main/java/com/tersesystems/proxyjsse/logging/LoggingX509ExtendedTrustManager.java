...
public class LoggingX509ExtendedTrustManager extends ProxyX509ExtendedTrustManager {
    ...
    public LoggingX509ExtendedTrustManager(Supplier<X509ExtendedTrustManager> supplier, MethodTracer tracer) {
    ...
    public void checkClientTrusted(X509Certificate[] chain, String authType, Socket socket) throws CertificateException {
        ...
        tracer.apply("checkClientTrusted", params, () -> super.checkClientTrusted(chain, authType, socket));
    }

    @Override
    public void checkServerTrusted(X509Certificate[] chain, String authType, Socket socket) throws CertificateException {
        Object[] params = { chain, authType, socket };
        tracer.apply("checkServerTrusted", params, () -> super.checkServerTrusted(chain, authType, socket));
    }

    @Override
    public void checkClientTrusted(X509Certificate[] chain, String authType, SSLEngine engine) throws CertificateException {
        Object[] params = { chain, authType, engine };
        tracer.apply("checkClientTrusted", params, () -> super.checkClientTrusted(chain, authType, engine));
    }

    @Override
    public void checkServerTrusted(X509Certificate[] chain, String authType, SSLEngine engine) throws CertificateException {
        Object[] params = { chain, authType, engine };
        tracer.apply("checkServerTrusted", params, () -> super.checkServerTrusted(chain, authType, engine));
    }
