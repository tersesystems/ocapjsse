...
public class LoggingX509ExtendedKeyManager extends ProxyX509ExtendedKeyManager {
    ...
    public LoggingX509ExtendedKeyManager(Supplier<X509ExtendedKeyManager> supplier, MethodTracer tracer) {
    ...
    public String chooseEngineClientAlias(String[] keyTypes, Principal[] issuers, SSLEngine engine) {
        ...
        return tracer.apply("chooseEngineClientAlias", params, () -> super.chooseEngineClientAlias(keyTypes, issuers, engine));
    }

    public String chooseEngineServerAlias(String keyTypes, Principal[] issuers, SSLEngine engine) {
        final Object[] params = {keyTypes, issuers, engine};
        return tracer.apply("chooseEngineServerAlias", params, () -> super.chooseEngineServerAlias(keyTypes, issuers, engine));
    }
    ...
    public String chooseClientAlias(String[] keyTypes, Principal[] issuers, Socket socket) {
        ...
        return tracer.apply("chooseClientAlias", params, () -> super.chooseClientAlias(keyTypes, issuers, socket));
    }
    ...
    public String chooseServerAlias(String keyType, Principal[] issuers, Socket socket) {
        ...
        return tracer.apply("chooseServerAlias", params, () -> super.chooseServerAlias(keyType, issuers, socket));
    }
